...
model_path     = ROOT / "models" / "autonomous_DrivativeOnEval.pth"
dataset_orig_path = ROOT / "data" / "processed" / "datasetOrig.pt"
dataset_att_path  = ROOT / "data" / "processed" / "datasetAttr.pt"
...
# ذخیره
output_html = ROOT / "attractors_orig_vs_att.html"
