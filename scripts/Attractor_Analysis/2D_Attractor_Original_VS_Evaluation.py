# scripts/Attractor_Analysis/attractors_orig_vs_att_2d.py
#
# 1) بارگذاری datasetOrig.pt → دنرمال → رسم اترکتور واقعی (2D: state1 vs state2)
# 2) بارگذاری datasetAtt.pt → گرفتن نقاط اولیه → حل Neural ODE با FTheta
#    → دنرمال → رسم اترکتور مدل برای دسته‌ی دوم (2D)
# 3) نمایش هر دو سری در یک شکل دو‌بعدی Plotly با دو رنگ متفاوت
...
ROOT = THIS_FILE.parents[2]  # اگر فایل در scripts/Attractor_Analysis باشد، parents[2] می‌شود ریشه‌ی پروژه
...
dataset_orig_path = ROOT / "data" / "processed" / "3BasinBothAttr.pt"
dataset_att_path  = ROOT / "data" / "processed" / "3BasinBothAttr.pt"
...
# =====================================================================
# 1) بارگذاری datasetOrig.pt و رسم اترکتور واقعی (2D)
# =====================================================================
...
# =====================================================================
# 4) رسم دو‌بعدی با Plotly: اترکتور واقعی + اترکتور مدل روی datasetAtt
#    (phase plot: state1 vs state2)
# =====================================================================
fig = go.Figure()

# 4-1) اترکتور واقعی (datasetOrig) - آبی
...
# 4-2) اترکتور مدل (datasetAtt) - قرمز
for i in range(num_runs_att):
