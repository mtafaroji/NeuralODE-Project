...
import numpy as np
import torch
import plotly.graph_objects as go  # for potential interactive plotting
...
# =====================================================================
# Real range for the vector field grid
# =====================================================================
x1_min_plot = -5.0
x1_max_plot = 5.0
x2_min_plot = -5.0
...
# =====================================================================
# Normalize arrow directions for visualization
# =====================================================================
...
plt.quiver(
    X_real[:, 0], X_real[:, 1],   # arrow starting points
    U_dir, V_dir,                 # directions
    angles="xy",
    scale_units="xy",
    scale=scale_value,
    width=0.003,
