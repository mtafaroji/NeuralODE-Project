...
# ------- Load processed data ---------------------
dataset = torch.load("data/processed/2Basin2.pt")#### Load Tensor dataSet of Basin2 ############################
...
f_theta.load_state_dict(torch.load("models/2Basin1FL0Der2.pth"))  #### Load pre-trained model on Basin1 ########################
optimizer = torch.optim.Adam(f_theta.parameters(), lr=1e-4)
mse = nn.MSELoss()
...
torch.save(f_theta.state_dict(), "models/2Basin1_then_basin2FL0Der2.pth") #### Save model trained  ############################
print("Model saved to models/2Basin1_then_basin2FL0Der2.pth")