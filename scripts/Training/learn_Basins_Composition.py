...
# ------- Load processed data ---------------------
dataset = torch.load("data/processed/test2.pt")                     #### Changed name of DataSet file ############################
...
f_theta.load_state_dict(torch.load("models/basin1_then_basin2.pth"))   #### Changed name of Loaded model ##########################
...
torch.save(f_theta.state_dict(), "models/basinComposedDisL2LD0.pth")  #### Changed name of saved model ############################
print("Model saved to models/refined.pth")